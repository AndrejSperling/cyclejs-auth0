...
var makeAuth0Driver = exports.makeAuth0Driver = (0, _makeAuth0Driver2.default)(_auth0Lock2.default, window.localStorage, window.location);
var protect = exports.protect = _protectComponent2.default;
exports.default = (0, _makeAuth0Driver2.default)(_auth0Lock2.default, window.localStorage, window.location);